        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              GHashTable * _elem0 = g_hash_table_new (NULL, NULL);
              {
                guint32 size;
                ThriftType key_type;
    ...
    {
      {
        ...
        {
          key = keys[i];
          value = (gchar *) g_hash_table_lookup (((GHashTable *) ((GHashTable*)g_ptr_array_index ((GPtrArray *) this_object->im_big, i3))), (gpointer) key);
...
t_test_old_school_finalize (GObject *object)
{
  ...
  {
    g_ptr_array_free (tobject->im_big, TRUE);
    tobject->im_big = NULL;
  }
}

static void 
t_test_old_school_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_old_school_finalize;
  cls->read = t_test_old_school_read;
  cls->write = t_test_old_school_write;
}
...
static void 
t_test_simple_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_simple_finalize;
  cls->read = t_test_simple_read;
  cls->write = t_test_simple_write;
}
...
static void 
t_test_tricky1_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_tricky1_finalize;
  cls->read = t_test_tricky1_read;
  cls->write = t_test_tricky1_write;
}
...
static void 
t_test_tricky2_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_tricky2_finalize;
  cls->read = t_test_tricky2_read;
  cls->write = t_test_tricky2_write;
}
...
static void 
t_test_tricky3_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_tricky3_finalize;
  cls->read = t_test_tricky3_read;
  cls->write = t_test_tricky3_write;
}
...
static void 
t_test_optional_default_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_optional_default_finalize;
  cls->read = t_test_optional_default_read;
  cls->write = t_test_optional_default_write;
}
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint16* key4 = g_new (gint16, 1);
              TTestSimple * val5 = NULL;
              if ((ret = thrift_protocol_read_i16 (protocol, &*key4, error)) < 0)
                return -1;
              xfer += ret;
              if ( val5 != NULL)
              {
              ...
              val5 = g_object_new (T_TEST_TYPE_SIMPLE, NULL);
              ...
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->the_map, (gpointer) key4, (gpointer) val5);
            }
...
t_test_complex_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    {
      key = keys[i];
      value = (TTestSimple *) g_hash_table_lookup (((GHashTable *) this_object->the_map), (gpointer) key);
...
t_test_complex_instance_init (TTestComplex * object)
{
  ...
  object->the_map = g_hash_table_new_full (g_int_hash, g_int_equal, NULL, g_object_unref);
...
static void 
t_test_complex_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_complex_finalize;
  cls->read = t_test_complex_read;
  cls->write = t_test_complex_write;
}
...
static void 
t_test_many_opt_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_many_opt_finalize;
  cls->read = t_test_many_opt_read;
  cls->write = t_test_many_opt_write;
}
...
t_test_java_test_helper_finalize (GObject *object)
{
  ...
  {
    g_free (tobject->req_bin);
    tobject->req_bin = NULL;
  }
  if (tobject->opt_bin != NULL)
  {
    g_free (tobject->opt_bin);
    tobject->opt_bin = NULL;
  }
}

static void 
t_test_java_test_helper_class_init (ThriftStructClass * cls)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (cls);

  gobject_class->finalize = t_test_java_test_helper_finalize;
  cls->read = t_test_java_test_helper_read;
  cls->write = t_test_java_test_helper_write;
}
