...
public class Backwards implements org.apache.thrift.TBase<Backwards, Backwards._Fields>, java.io.Serializable, Cloneable, Comparable<Backwards> {
  ...
  static {
    schemes.put(StandardScheme.class, new BackwardsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BackwardsTupleSchemeFactory());
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case FIRST_TAG2:
      return Integer.valueOf(getFirst_tag2());

    case SECOND_TAG1:
      return Integer.valueOf(getSecond_tag1());
  ...
  public int hashCode() {
    ...
    boolean present_first_tag2 = true;
    builder.append(present_first_tag2);
    if (present_first_tag2)
      builder.append(first_tag2);

    boolean present_second_tag1 = true;
    builder.append(present_second_tag1);
    if (present_second_tag1)
      builder.append(second_tag1);
