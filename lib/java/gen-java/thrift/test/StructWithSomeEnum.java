...
public class StructWithSomeEnum implements org.apache.thrift.TBase<StructWithSomeEnum, StructWithSomeEnum._Fields>, java.io.Serializable, Cloneable, Comparable<StructWithSomeEnum> {
  ...
  static {
    schemes.put(StandardScheme.class, new StructWithSomeEnumStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StructWithSomeEnumTupleSchemeFactory());
  }
        ...
        switch (schemeField.id) {
          case 1: // BLAH
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.blah = SomeEnum.findByValue(iprot.readI32());
