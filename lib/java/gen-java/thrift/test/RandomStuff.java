...
public class RandomStuff implements org.apache.thrift.TBase<RandomStuff, RandomStuff._Fields>, java.io.Serializable, Cloneable, Comparable<RandomStuff> {
  ...
  static {
    schemes.put(StandardScheme.class, new RandomStuffStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RandomStuffTupleSchemeFactory());
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case BIGINT:
      return Long.valueOf(getBigint());

    case TRIPLE:
      return Double.valueOf(getTriple());
  ...
  public int hashCode() {
    ...
    builder.append(present_a);
    if (present_a)
      builder.append(a);

    boolean present_b = true;
    builder.append(present_b);
    if (present_b)
      builder.append(b);

    boolean present_c = true;
    builder.append(present_c);
    if (present_c)
      builder.append(c);

    boolean present_d = true;
    builder.append(present_d);
    if (present_d)
      builder.append(d);

    boolean present_myintlist = true && (isSetMyintlist());
    builder.append(present_myintlist);
    if (present_myintlist)
      builder.append(myintlist);

    boolean present_maps = true && (isSetMaps());
    builder.append(present_maps);
    if (present_maps)
      builder.append(maps);

    boolean present_bigint = true;
    builder.append(present_bigint);
    if (present_bigint)
      builder.append(bigint);

    boolean present_triple = true;
    builder.append(present_triple);
    if (present_triple)
