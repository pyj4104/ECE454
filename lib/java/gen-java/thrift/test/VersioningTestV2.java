...
public class VersioningTestV2 implements org.apache.thrift.TBase<VersioningTestV2, VersioningTestV2._Fields>, java.io.Serializable, Cloneable, Comparable<VersioningTestV2> {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case BEGIN_IN_BOTH:
      return Integer.valueOf(getBegin_in_both());

    case NEWINT:
      return Integer.valueOf(getNewint());

    case NEWBYTE:
      return Byte.valueOf(getNewbyte());

    case NEWSHORT:
      return Short.valueOf(getNewshort());

    case NEWLONG:
      return Long.valueOf(getNewlong());

    case NEWDOUBLE:
      return Double.valueOf(getNewdouble());
    ...
    case END_IN_BOTH:
      return Integer.valueOf(getEnd_in_both());
  ...
  public int hashCode() {
    ...
    builder.append(present_begin_in_both);
    if (present_begin_in_both)
      builder.append(begin_in_both);

    boolean present_newint = true;
    builder.append(present_newint);
    if (present_newint)
      builder.append(newint);

    boolean present_newbyte = true;
    builder.append(present_newbyte);
    if (present_newbyte)
      builder.append(newbyte);

    boolean present_newshort = true;
    builder.append(present_newshort);
    if (present_newshort)
      builder.append(newshort);

    boolean present_newlong = true;
    builder.append(present_newlong);
    if (present_newlong)
      builder.append(newlong);

    boolean present_newdouble = true;
    builder.append(present_newdouble);
    if (present_newdouble)
      builder.append(newdouble);

    boolean present_newstruct = true && (isSetNewstruct());
    builder.append(present_newstruct);
    if (present_newstruct)
      builder.append(newstruct);

    boolean present_newlist = true && (isSetNewlist());
    builder.append(present_newlist);
    if (present_newlist)
      builder.append(newlist);

    boolean present_newset = true && (isSetNewset());
    builder.append(present_newset);
    if (present_newset)
      builder.append(newset);

    boolean present_newmap = true && (isSetNewmap());
    builder.append(present_newmap);
    if (present_newmap)
      builder.append(newmap);

    boolean present_newstring = true && (isSetNewstring());
    builder.append(present_newstring);
    if (present_newstring)
      builder.append(newstring);

    boolean present_end_in_both = true;
    builder.append(present_end_in_both);
    if (present_end_in_both)
      builder.append(end_in_both);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i95 = 0; _i95 < _map94.size; ++_i95)
                {
                  ...
                  struct.newmap.put(_key96, _val97);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(9)) {
        {
          ...
          for (int _i111 = 0; _i111 < _map110.size; ++_i111)
          {
            ...
            struct.newmap.put(_key112, _val113);
          }
        }
        struct.setNewmapIsSet(true);
      }
