...
public class Xtruct3 implements org.apache.thrift.TBase<Xtruct3, Xtruct3._Fields>, java.io.Serializable, Cloneable, Comparable<Xtruct3> {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case CHANGED:
      return Integer.valueOf(getChanged());
  ...
  public int hashCode() {
    ...
    builder.append(present_string_thing);
    if (present_string_thing)
      builder.append(string_thing);

    boolean present_changed = true;
    builder.append(present_changed);
    if (present_changed)
      builder.append(changed);

    boolean present_i32_thing = true;
    builder.append(present_i32_thing);
    if (present_i32_thing)
      builder.append(i32_thing);

    boolean present_i64_thing = true;
    builder.append(present_i64_thing);
    if (present_i64_thing)
      builder.append(i64_thing);
