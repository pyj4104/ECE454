...
public class Base64 implements org.apache.thrift.TBase<Base64, Base64._Fields>, java.io.Serializable, Cloneable, Comparable<Base64> {
  ...
  static {
    schemes.put(StandardScheme.class, new Base64StandardSchemeFactory());
    schemes.put(TupleScheme.class, new Base64TupleSchemeFactory());
  }
...
;
  ...
  public Base64 setB1(byte[] b1) {
    setB1(b1 == null ? (ByteBuffer)null : ByteBuffer.wrap(b1));
    return this;
  }
  ...
  public Base64 setB2(byte[] b2) {
    setB2(b2 == null ? (ByteBuffer)null : ByteBuffer.wrap(b2));
    return this;
  }
  ...
  public Base64 setB3(byte[] b3) {
    setB3(b3 == null ? (ByteBuffer)null : ByteBuffer.wrap(b3));
    return this;
  }
  ...
  public Base64 setB4(byte[] b4) {
    setB4(b4 == null ? (ByteBuffer)null : ByteBuffer.wrap(b4));
    return this;
  }
  ...
  public Base64 setB5(byte[] b5) {
    setB5(b5 == null ? (ByteBuffer)null : ByteBuffer.wrap(b5));
    return this;
  }
  ...
  public Base64 setB6(byte[] b6) {
    setB6(b6 == null ? (ByteBuffer)null : ByteBuffer.wrap(b6));
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_b5);
    if (present_b5)
      builder.append(b5);

    boolean present_b6 = true && (isSetB6());
    builder.append(present_b6);
    if (present_b6)
      builder.append(b6);
