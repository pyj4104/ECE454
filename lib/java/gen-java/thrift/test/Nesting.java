...
public class Nesting implements org.apache.thrift.TBase<Nesting, Nesting._Fields>, java.io.Serializable, Cloneable, Comparable<Nesting> {
  ...
  static {
    schemes.put(StandardScheme.class, new NestingStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NestingTupleSchemeFactory());
  }
  ...
  public int hashCode() {
    ...
    boolean present_my_bonk = true && (isSetMy_bonk());
    builder.append(present_my_bonk);
    if (present_my_bonk)
      builder.append(my_bonk);

    boolean present_my_ooe = true && (isSetMy_ooe());
    builder.append(present_my_ooe);
    if (present_my_ooe)
      builder.append(my_ooe);
