...
public class Simple implements org.apache.thrift.TBase<Simple, Simple._Fields>, java.io.Serializable, Cloneable, Comparable<Simple> {
  ...
  private _Fields optionals[] = {_Fields.IM_OPTIONAL};
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case IM_DEFAULT:
      return Short.valueOf(getIm_default());

    case IM_REQUIRED:
      return Short.valueOf(getIm_required());

    case IM_OPTIONAL:
      return Short.valueOf(getIm_optional());
  ...
  public int hashCode() {
    ...
    boolean present_im_default = true;
    builder.append(present_im_default);
    if (present_im_default)
      builder.append(im_default);

    boolean present_im_required = true;
    builder.append(present_im_required);
    if (present_im_required)
      builder.append(im_required);

    boolean present_im_optional = true && (isSetIm_optional());
    builder.append(present_im_optional);
    if (present_im_optional)
      builder.append(im_optional);
