...
public class JavaTestHelper implements org.apache.thrift.TBase<JavaTestHelper, JavaTestHelper._Fields>, java.io.Serializable, Cloneable, Comparable<JavaTestHelper> {
  ...
  static {
    schemes.put(StandardScheme.class, new JavaTestHelperStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JavaTestHelperTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.OPT_INT,_Fields.OPT_OBJ,_Fields.OPT_BIN};
...
;
  ...
  public JavaTestHelper setReq_bin(byte[] req_bin) {
    setReq_bin(req_bin == null ? (ByteBuffer)null : ByteBuffer.wrap(req_bin));
    return this;
  }
  ...
  public JavaTestHelper setOpt_bin(byte[] opt_bin) {
    setOpt_bin(opt_bin == null ? (ByteBuffer)null : ByteBuffer.wrap(opt_bin));
    return this;
  }

  public JavaTestHelper setOpt_bin(ByteBuffer opt_bin) {
    this.opt_bin = opt_bin;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case REQ_INT:
      return Integer.valueOf(getReq_int());

    case OPT_INT:
      return Integer.valueOf(getOpt_int());
  ...
  public int hashCode() {
    ...
    boolean present_req_int = true;
    builder.append(present_req_int);
    if (present_req_int)
      builder.append(req_int);
    ...
    boolean present_req_obj = true && (isSetReq_obj());
    builder.append(present_req_obj);
    if (present_req_obj)
      builder.append(req_obj);

    boolean present_opt_obj = true && (isSetOpt_obj());
    builder.append(present_opt_obj);
    if (present_opt_obj)
      builder.append(opt_obj);

    boolean present_req_bin = true && (isSetReq_bin());
    builder.append(present_req_bin);
    if (present_req_bin)
      builder.append(req_bin);

    boolean present_opt_bin = true && (isSetOpt_bin());
    builder.append(present_opt_bin);
    if (present_opt_bin)
      builder.append(opt_bin);
