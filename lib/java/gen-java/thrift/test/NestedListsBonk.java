      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i280 = 0; _i280 < _list279.size; ++_i280)
          {
            List<List<Bonk>> _elem281;
            {
              ...
              _elem281 = new ArrayList<List<Bonk>>(_list282.size);
              for (int _i283 = 0; _i283 < _list282.size; ++_i283)
              {
                List<Bonk> _elem284;
                {
                  ...
                  _elem284 = new ArrayList<Bonk>(_list285.size);
