...
public class Doubles implements org.apache.thrift.TBase<Doubles, Doubles._Fields>, java.io.Serializable, Cloneable, Comparable<Doubles> {
  ...
  private static final org.apache.thrift.protocol.TField SMALL_FIELD_DESC = new org.apache.thrift.protocol.TField("small", org.apache.thrift.protocol.TType.DOUBLE, (short)6);
  ...
  static {
    schemes.put(StandardScheme.class, new DoublesStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DoublesTupleSchemeFactory());
  }
  ...
  static {
    ...
    tmpMap.put(_Fields.BIG, new org.apache.thrift.meta_data.FieldMetaData("big", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.SMALL, new org.apache.thrift.meta_data.FieldMetaData("small", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
  ...
  public int hashCode() {
    ...
    boolean present_nan = true;
    builder.append(present_nan);
    if (present_nan)
      builder.append(nan);

    boolean present_inf = true;
    builder.append(present_inf);
    if (present_inf)
      builder.append(inf);

    boolean present_neginf = true;
    builder.append(present_neginf);
    if (present_neginf)
      builder.append(neginf);

    boolean present_repeating = true;
    builder.append(present_repeating);
    if (present_repeating)
      builder.append(repeating);

    boolean present_big = true;
    builder.append(present_big);
    if (present_big)
      builder.append(big);

    boolean present_small = true;
    builder.append(present_small);
    if (present_small)
      builder.append(small);

    boolean present_zero = true;
    builder.append(present_zero);
    if (present_zero)
      builder.append(zero);

    boolean present_negzero = true;
    builder.append(present_negzero);
    if (present_negzero)
      builder.append(negzero);
  ...
  private static class DoublesStandardScheme extends StandardScheme<Doubles> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Doubles struct) throws org.apache.thrift.TException {
      ...
      oprot.writeDouble(struct.small);
      oprot.writeFieldEnd();
