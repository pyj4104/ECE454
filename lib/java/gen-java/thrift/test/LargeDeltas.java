...
public class LargeDeltas implements org.apache.thrift.TBase<LargeDeltas, LargeDeltas._Fields>, java.io.Serializable, Cloneable, Comparable<LargeDeltas> {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case CHECK_TRUE:
      return Boolean.valueOf(isCheck_true());

    case B1000:
      return getB1000();

    case CHECK_FALSE:
      return Boolean.valueOf(isCheck_false());
  ...
  public int hashCode() {
    ...
    builder.append(present_b10);
    if (present_b10)
      builder.append(b10);

    boolean present_b100 = true && (isSetB100());
    builder.append(present_b100);
    if (present_b100)
      builder.append(b100);

    boolean present_check_true = true;
    builder.append(present_check_true);
    if (present_check_true)
      builder.append(check_true);

    boolean present_b1000 = true && (isSetB1000());
    builder.append(present_b1000);
    if (present_b1000)
      builder.append(b1000);

    boolean present_check_false = true;
    builder.append(present_check_false);
    if (present_check_false)
      builder.append(check_false);

    boolean present_vertwo2000 = true && (isSetVertwo2000());
    builder.append(present_vertwo2000);
    if (present_vertwo2000)
      builder.append(vertwo2000);

    boolean present_a_set2500 = true && (isSetA_set2500());
    builder.append(present_a_set2500);
    if (present_a_set2500)
      builder.append(a_set2500);

    boolean present_vertwo3000 = true && (isSetVertwo3000());
    builder.append(present_vertwo3000);
    if (present_vertwo3000)
      builder.append(vertwo3000);

    boolean present_big_numbers = true && (isSetBig_numbers());
    builder.append(present_big_numbers);
    if (present_big_numbers)
      builder.append(big_numbers);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i144 = 0; _i144 < _list143.size; ++_i144)
                {
                  ...
                  struct.big_numbers.add(_elem145);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(9)) {
        {
          ...
          for (int _i154 = 0; _i154 < _list153.size; ++_i154)
          {
            ...
            struct.big_numbers.add(_elem155);
          }
        }
        struct.setBig_numbersIsSet(true);
      }
