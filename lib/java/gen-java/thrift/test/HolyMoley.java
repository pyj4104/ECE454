...
public class HolyMoley implements org.apache.thrift.TBase<HolyMoley, HolyMoley._Fields>, java.io.Serializable, Cloneable, Comparable<HolyMoley> {
  ...
  static {
    schemes.put(StandardScheme.class, new HolyMoleyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HolyMoleyTupleSchemeFactory());
  }
  ...
  public int hashCode() {
    ...
    boolean present_big = true && (isSetBig());
    builder.append(present_big);
    if (present_big)
      builder.append(big);

    boolean present_contain = true && (isSetContain());
    builder.append(present_contain);
    if (present_contain)
      builder.append(contain);

    boolean present_bonks = true && (isSetBonks());
    builder.append(present_bonks);
    if (present_bonks)
      builder.append(bonks);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  OneOfEach _elem26;
                  _elem26 = new OneOfEach();
                  _elem26.read(iprot);
                  struct.big.add(_elem26);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                for (int _i28 = 0; _i28 < _set27.size; ++_i28)
                {
                  List<String> _elem29;
                  {
                    ...
                    _elem29 = new ArrayList<String>(_list30.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i34 = 0; _i34 < _map33.size; ++_i34)
                {
                  ...
                  _key35 = iprot.readString();
                  {
                    ...
                    _val36 = new ArrayList<Bonk>(_list37.size);
                  ...
                  struct.bonks.put(_key35, _val36);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            OneOfEach _elem52;
            _elem52 = new OneOfEach();
            _elem52.read(iprot);
            struct.big.add(_elem52);
          }
        }
        struct.setBigIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          for (int _i54 = 0; _i54 < _set53.size; ++_i54)
          {
            List<String> _elem55;
            {
              ...
              _elem55 = new ArrayList<String>(_list56.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i60 = 0; _i60 < _map59.size; ++_i60)
          {
            ...
            _key61 = iprot.readString();
            {
              ...
              _val62 = new ArrayList<Bonk>(_list63.size);
            ...
            struct.bonks.put(_key61, _val62);
          }
        }
        struct.setBonksIsSet(true);
      }
