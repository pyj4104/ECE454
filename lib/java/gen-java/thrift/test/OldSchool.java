...
public class OldSchool implements org.apache.thrift.TBase<OldSchool, OldSchool._Fields>, java.io.Serializable, Cloneable, Comparable<OldSchool> {
  ...
  static {
    schemes.put(StandardScheme.class, new OldSchoolStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OldSchoolTupleSchemeFactory());
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case IM_INT:
      return Short.valueOf(getIm_int());
  ...
  public int hashCode() {
    ...
    boolean present_im_int = true;
    builder.append(present_im_int);
    if (present_im_int)
      builder.append(im_int);

    boolean present_im_str = true && (isSetIm_str());
    builder.append(present_im_str);
    if (present_im_str)
      builder.append(im_str);

    boolean present_im_big = true && (isSetIm_big());
    builder.append(present_im_big);
    if (present_im_big)
      builder.append(im_big);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  Map<Integer,String> _elem2;
                  {
                    org.apache.thrift.protocol.TMap _map3 = iprot.readMapBegin();
                    _elem2 = new HashMap<Integer,String>(2*_map3.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i12 = 0; _i12 < _list11.size; ++_i12)
          {
            Map<Integer,String> _elem13;
            {
              ...
              _elem13 = new HashMap<Integer,String>(2*_map14.size);
