        ...
        case STRUCT_LIST:
          if (field.type == STRUCT_LIST_FIELD_DESC.type) {
            List<RandomStuff> struct_list;
            {
              ...
              {
                RandomStuff _elem682;
                _elem682 = new RandomStuff();
                _elem682.read(iprot);
                struct_list.add(_elem682);
              }
              iprot.readListEnd();
            }
            return struct_list;
        ...
        case I32_SET:
          if (field.type == I32_SET_FIELD_DESC.type) {
            Set<Integer> i32_set;
            {
              ...
              for (int _i684 = 0; _i684 < _set683.size; ++_i684)
              {
                int _elem685;
                _elem685 = iprot.readI32();
                i32_set.add(_elem685);
              }
              iprot.readSetEnd();
            }
            return i32_set;
          ...
          if (field.type == I32_MAP_FIELD_DESC.type) {
            Map<Integer,Integer> i32_map;
            {
              ...
              for (int _i687 = 0; _i687 < _map686.size; ++_i687)
              {
                int _key688;
                int _val689;
                _key688 = iprot.readI32();
                _val689 = iprot.readI32();
                i32_map.put(_key688, _val689);
              }
              iprot.readMapEnd();
            }
            return i32_map;
      ...
      switch (setField) {
        ...
        case STRUCT_LIST:
          List<RandomStuff> struct_list;
          {
            ...
            {
              RandomStuff _elem695;
              _elem695 = new RandomStuff();
              _elem695.read(iprot);
              struct_list.add(_elem695);
            }
            iprot.readListEnd();
          }
          return struct_list;
        ...
        case I32_SET:
          Set<Integer> i32_set;
          {
            ...
            for (int _i697 = 0; _i697 < _set696.size; ++_i697)
            {
              int _elem698;
              _elem698 = iprot.readI32();
              i32_set.add(_elem698);
            }
            iprot.readSetEnd();
          }
          return i32_set;
        case I32_MAP:
          Map<Integer,Integer> i32_map;
          {
            ...
            for (int _i700 = 0; _i700 < _map699.size; ++_i700)
            {
              int _key701;
              int _val702;
              _key701 = iprot.readI32();
              _val702 = iprot.readI32();
              i32_map.put(_key701, _val702);
            }
            iprot.readMapEnd();
          }
          return i32_map;
