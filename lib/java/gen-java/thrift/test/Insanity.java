...
public class Insanity implements org.apache.thrift.TBase<Insanity, Insanity._Fields>, java.io.Serializable, Cloneable, Comparable<Insanity> {
  ...
  public int hashCode() {
    ...
    builder.append(present_xtructs);
    if (present_xtructs)
      builder.append(xtructs);
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i12 = 0; _i12 < _map11.size; ++_i12)
          {
            Numberz _key13;
            long _val14;
            _key13 = Numberz.findByValue(iprot.readI32());
            _val14 = iprot.readI64();
            struct.userMap.put(_key13, _val14);
          }
        }
        struct.setUserMapIsSet(true);
      }
