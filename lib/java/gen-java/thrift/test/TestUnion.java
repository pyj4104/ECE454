...
public class TestUnion extends org.apache.thrift.TUnion<TestUnion, TestUnion._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.I32_FIELD, new org.apache.thrift.meta_data.FieldMetaData("i32_field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.STRUCT_FIELD, new org.apache.thrift.meta_data.FieldMetaData("struct_field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.OTHER_I32_FIELD, new org.apache.thrift.meta_data.FieldMetaData("other_i32_field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ENUM_FIELD, new org.apache.thrift.meta_data.FieldMetaData("enum_field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.I32_SET, new org.apache.thrift.meta_data.FieldMetaData("i32_set", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.SetMetaData(org.apache.thrift.protocol.TType.SET, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.I32_MAP, new org.apache.thrift.meta_data.FieldMetaData("i32_map", org.apache.thrift.TFieldRequirementType.DEFAULT, 
      ...
      switch (setField) {
        ...
        case STRUCT_LIST:
          if (field.type == STRUCT_LIST_FIELD_DESC.type) {
            List<RandomStuff> struct_list;
            {
              ...
              {
                RandomStuff _elem656;
                _elem656 = new RandomStuff();
                _elem656.read(iprot);
                struct_list.add(_elem656);
              }
              iprot.readListEnd();
            }
            return struct_list;
        ...
        case ENUM_FIELD:
          if (field.type == ENUM_FIELD_FIELD_DESC.type) {
            SomeEnum enum_field;
            enum_field = SomeEnum.findByValue(iprot.readI32());
            return enum_field;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
        ...
        case I32_SET:
          if (field.type == I32_SET_FIELD_DESC.type) {
            Set<Integer> i32_set;
            {
              ...
              for (int _i658 = 0; _i658 < _set657.size; ++_i658)
              {
                int _elem659;
                _elem659 = iprot.readI32();
                i32_set.add(_elem659);
              }
              iprot.readSetEnd();
            }
            return i32_set;
      ...
      switch (setField) {
        ...
        case STRUCT_LIST:
          List<RandomStuff> struct_list;
          {
            ...
            {
              RandomStuff _elem669;
              _elem669 = new RandomStuff();
              _elem669.read(iprot);
              struct_list.add(_elem669);
            }
            iprot.readListEnd();
          }
          return struct_list;
        ...
        case I32_SET:
          Set<Integer> i32_set;
          {
            ...
            for (int _i671 = 0; _i671 < _set670.size; ++_i671)
            {
              int _elem672;
              _elem672 = iprot.readI32();
              i32_set.add(_elem672);
            }
            iprot.readSetEnd();
          }
          return i32_set;
        case I32_MAP:
          Map<Integer,Integer> i32_map;
          {
            ...
            for (int _i674 = 0; _i674 < _map673.size; ++_i674)
            {
              int _key675;
              int _val676;
              _key675 = iprot.readI32();
              _val676 = iprot.readI32();
              i32_map.put(_key675, _val676);
            }
            iprot.readMapEnd();
          }
          return i32_map;
