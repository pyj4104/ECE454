...
public class OneOfEach implements org.apache.thrift.TBase<OneOfEach, OneOfEach._Fields>, java.io.Serializable, Cloneable, Comparable<OneOfEach> {
  ...
  static {
    schemes.put(StandardScheme.class, new OneOfEachStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OneOfEachTupleSchemeFactory());
  }
...
;
  ...
  public OneOfEach setBase64(byte[] base64) {
    setBase64(base64 == null ? (ByteBuffer)null : ByteBuffer.wrap(base64));
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_im_true);
    if (present_im_true)
      builder.append(im_true);

    boolean present_im_false = true;
    builder.append(present_im_false);
    if (present_im_false)
      builder.append(im_false);

    boolean present_a_bite = true;
    builder.append(present_a_bite);
    if (present_a_bite)
      builder.append(a_bite);

    boolean present_integer16 = true;
    builder.append(present_integer16);
    if (present_integer16)
      builder.append(integer16);

    boolean present_integer32 = true;
    builder.append(present_integer32);
    if (present_integer32)
      builder.append(integer32);

    boolean present_integer64 = true;
    builder.append(present_integer64);
    if (present_integer64)
      builder.append(integer64);

    boolean present_double_precision = true;
    builder.append(present_double_precision);
    if (present_double_precision)
      builder.append(double_precision);

    boolean present_some_characters = true && (isSetSome_characters());
    builder.append(present_some_characters);
    if (present_some_characters)
      builder.append(some_characters);

    boolean present_zomg_unicode = true && (isSetZomg_unicode());
    builder.append(present_zomg_unicode);
    if (present_zomg_unicode)
      builder.append(zomg_unicode);

    boolean present_what_who = true;
    builder.append(present_what_who);
    if (present_what_who)
      builder.append(what_who);

    boolean present_base64 = true && (isSetBase64());
    builder.append(present_base64);
    if (present_base64)
