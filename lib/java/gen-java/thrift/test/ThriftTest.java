...
public class ThriftTest {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class testOneway_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("testOneway", org.apache.thrift.protocol.TMessageType.CALL, 0));
        testOneway_args args = new testOneway_args();
        args.setSecondsToSleep(secondsToSleep);
        args.write(prot);
        prot.writeMessageEnd();
...
;
  ...
  public static class testDouble_args implements org.apache.thrift.TBase<testDouble_args, testDouble_args._Fields>, java.io.Serializable, Cloneable, Comparable<testDouble_args>   {
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case THING:
        return Double.valueOf(getThing());
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  for (int _i289 = 0; _i289 < _map288.size; ++_i289)
                  {
                    ...
                    struct.thing.put(_key290, _val291);
                  }
                  iprot.readMapEnd();
                }
                struct.setThingIsSet(true);
        ...
        if (incoming.get(0)) {
          {
            ...
            for (int _i295 = 0; _i295 < _map294.size; ++_i295)
            {
              ...
              struct.thing.put(_key296, _val297);
            }
          }
          struct.setThingIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  for (int _i309 = 0; _i309 < _map308.size; ++_i309)
                  {
                    ...
                    struct.thing.put(_key310, _val311);
                  }
                  iprot.readMapEnd();
                }
                struct.setThingIsSet(true);
        ...
        if (incoming.get(0)) {
          {
            ...
            for (int _i315 = 0; _i315 < _map314.size; ++_i315)
            {
              ...
              struct.thing.put(_key316, _val317);
            }
          }
          struct.setThingIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  for (int _i329 = 0; _i329 < _set328.size; ++_i329)
                  {
                    int _elem330;
                    _elem330 = iprot.readI32();
                    struct.thing.add(_elem330);
                  }
                  iprot.readSetEnd();
                }
                struct.setThingIsSet(true);
        ...
        if (incoming.get(0)) {
          {
            ...
            for (int _i373 = 0; _i373 < _map372.size; ++_i373)
            {
              ...
              _key374 = iprot.readI32();
              {
                ...
                _val375 = new HashMap<Integer,Integer>(2*_map376.size);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  {
                    long _key382;
                    Map<Numberz,Insanity> _val383;
                    _key382 = iprot.readI64();
                    {
                      org.apache.thrift.protocol.TMap _map384 = iprot.readMapBegin();
                      _val383 = new HashMap<Numberz,Insanity>(2*_map384.size);
                      for (int _i385 = 0; _i385 < _map384.size; ++_i385)
                      {
                        Numberz _key386;
                        Insanity _val387;
                        _key386 = Numberz.findByValue(iprot.readI32());
                        _val387 = new Insanity();
                        _val387.read(iprot);
        ...
        if (incoming.get(0)) {
          {
            ...
            for (int _i393 = 0; _i393 < _map392.size; ++_i393)
            {
              ...
              _key394 = iprot.readI64();
              {
                ...
                _val395 = new HashMap<Numberz,Insanity>(2*_map396.size);
                for (int _i397 = 0; _i397 < _map396.size; ++_i397)
                {
                  Numberz _key398;
                  Insanity _val399;
                  _key398 = Numberz.findByValue(iprot.readI32());
                  _val399 = new Insanity();
                  _val399.read(iprot);
  ...
  public static class testMulti_args implements org.apache.thrift.TBase<testMulti_args, testMulti_args._Fields>, java.io.Serializable, Cloneable, Comparable<testMulti_args>   {
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case ARG0:
        return Byte.valueOf(getArg0());

      case ARG1:
        return Integer.valueOf(getArg1());

      case ARG2:
        return Long.valueOf(getArg2());
    ...
    public int hashCode() {
      ...
      builder.append(present_arg0);
      if (present_arg0)
        builder.append(arg0);

      boolean present_arg1 = true;
      builder.append(present_arg1);
      if (present_arg1)
        builder.append(arg1);

      boolean present_arg2 = true;
      builder.append(present_arg2);
      if (present_arg2)
        builder.append(arg2);

      boolean present_arg3 = true && (isSetArg3());
      builder.append(present_arg3);
      if (present_arg3)
        builder.append(arg3);

      boolean present_arg4 = true && (isSetArg4());
      builder.append(present_arg4);
      if (present_arg4)
        builder.append(arg4.getValue());

      boolean present_arg5 = true;
      builder.append(present_arg5);
      if (present_arg5)
        builder.append(arg5);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  for (int _i401 = 0; _i401 < _map400.size; ++_i401)
                  {
                    short _key402;
                    String _val403;
                    _key402 = iprot.readI16();
                    _val403 = iprot.readString();
                    struct.arg3.put(_key402, _val403);
                  }
                  iprot.readMapEnd();
                }
        ...
        if (incoming.get(3)) {
          {
            ...
            for (int _i407 = 0; _i407 < _map406.size; ++_i407)
            {
              short _key408;
              String _val409;
              _key408 = iprot.readI16();
              _val409 = iprot.readString();
              struct.arg3.put(_key408, _val409);
            }
          }
          struct.setArg3IsSet(true);
        }
  ...
  public static class testOneway_args implements org.apache.thrift.TBase<testOneway_args, testOneway_args._Fields>, java.io.Serializable, Cloneable, Comparable<testOneway_args>   {
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case SECONDS_TO_SLEEP:
        return Integer.valueOf(getSecondsToSleep());
    ...
    public int hashCode() {
      ...
      builder.append(present_secondsToSleep);
      if (present_secondsToSleep)
        builder.append(secondsToSleep);
