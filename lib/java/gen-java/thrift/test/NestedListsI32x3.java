...
public class NestedListsI32x3 implements org.apache.thrift.TBase<NestedListsI32x3, NestedListsI32x3._Fields>, java.io.Serializable, Cloneable, Comparable<NestedListsI32x3> {
  ...
  public int hashCode() {
    ...
    builder.append(present_integerlist);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i173 = 0; _i173 < _list172.size; ++_i173)
                {
                  ...
                  struct.integerlist.add(_elem174);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i188 = 0; _i188 < _list187.size; ++_i188)
          {
            List<List<Integer>> _elem189;
            {
              ...
              _elem189 = new ArrayList<List<Integer>>(_list190.size);
              for (int _i191 = 0; _i191 < _list190.size; ++_i191)
              {
                List<Integer> _elem192;
                {
                  ...
                  _elem192 = new ArrayList<Integer>(_list193.size);
            ...
            struct.integerlist.add(_elem189);
          }
        }
        struct.setIntegerlistIsSet(true);
      }
