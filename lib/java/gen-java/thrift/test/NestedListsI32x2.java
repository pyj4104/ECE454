            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  List<Integer> _elem158;
                  {
                    org.apache.thrift.protocol.TList _list159 = iprot.readListBegin();
                    _elem158 = new ArrayList<Integer>(_list159.size);
                  ...
                  struct.integerlist.add(_elem158);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i167 = 0; _i167 < _list166.size; ++_i167)
          {
            List<Integer> _elem168;
            {
              ...
              _elem168 = new ArrayList<Integer>(_list169.size);
            ...
            struct.integerlist.add(_elem168);
          }
        }
        struct.setIntegerlistIsSet(true);
      }
