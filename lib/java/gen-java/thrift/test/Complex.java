...
public class Complex implements org.apache.thrift.TBase<Complex, Complex._Fields>, java.io.Serializable, Cloneable, Comparable<Complex> {
  ...
  private _Fields optionals[] = {_Fields.CP_OPTIONAL,_Fields.OPT_SIMP};
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case CP_DEFAULT:
      return Short.valueOf(getCp_default());

    case CP_REQUIRED:
      return Short.valueOf(getCp_required());

    case CP_OPTIONAL:
      return Short.valueOf(getCp_optional());
  ...
  public int hashCode() {
    ...
    boolean present_cp_default = true;
    builder.append(present_cp_default);
    if (present_cp_default)
      builder.append(cp_default);

    boolean present_cp_required = true;
    builder.append(present_cp_required);
    if (present_cp_required)
      builder.append(cp_required);

    boolean present_cp_optional = true && (isSetCp_optional());
    builder.append(present_cp_optional);
    if (present_cp_optional)
      builder.append(cp_optional);

    boolean present_the_map = true && (isSetThe_map());
    builder.append(present_the_map);
    if (present_the_map)
      builder.append(the_map);

    boolean present_req_simp = true && (isSetReq_simp());
    builder.append(present_req_simp);
    if (present_req_simp)
      builder.append(req_simp);

    boolean present_opt_simp = true && (isSetOpt_simp());
    builder.append(present_opt_simp);
    if (present_opt_simp)
      builder.append(opt_simp);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i19 = 0; _i19 < _map18.size; ++_i19)
                {
                  short _key20;
                  Simple _val21;
                  _key20 = iprot.readI16();
                  _val21 = new Simple();
                  _val21.read(iprot);
                  struct.the_map.put(_key20, _val21);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i25 = 0; _i25 < _map24.size; ++_i25)
          {
            ...
            _val27 = new Simple();
            _val27.read(iprot);
            struct.the_map.put(_key26, _val27);
          }
        }
        struct.setThe_mapIsSet(true);
      }
