...
public class ManyOpt implements org.apache.thrift.TBase<ManyOpt, ManyOpt._Fields>, java.io.Serializable, Cloneable, Comparable<ManyOpt> {
  ...
  static {
    schemes.put(StandardScheme.class, new ManyOptStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ManyOptTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.OPT1,_Fields.OPT2,_Fields.OPT3,_Fields.OPT5,_Fields.OPT6};
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case OPT1:
      return Integer.valueOf(getOpt1());

    case OPT2:
      return Integer.valueOf(getOpt2());

    case OPT3:
      return Integer.valueOf(getOpt3());

    case DEF4:
      return Integer.valueOf(getDef4());

    case OPT5:
      return Integer.valueOf(getOpt5());

    case OPT6:
      return Integer.valueOf(getOpt6());
  ...
  public int hashCode() {
    ...
    boolean present_opt1 = true && (isSetOpt1());
    builder.append(present_opt1);
    if (present_opt1)
      builder.append(opt1);

    boolean present_opt2 = true && (isSetOpt2());
    builder.append(present_opt2);
    if (present_opt2)
      builder.append(opt2);

    boolean present_opt3 = true && (isSetOpt3());
    builder.append(present_opt3);
    if (present_opt3)
      builder.append(opt3);
    ...
    boolean present_opt5 = true && (isSetOpt5());
    builder.append(present_opt5);
    if (present_opt5)
      builder.append(opt5);

    boolean present_opt6 = true && (isSetOpt6());
    builder.append(present_opt6);
    if (present_opt6)
      builder.append(opt6);
