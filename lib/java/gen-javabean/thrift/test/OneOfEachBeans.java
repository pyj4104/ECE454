...
public class OneOfEachBeans implements org.apache.thrift.TBase<OneOfEachBeans, OneOfEachBeans._Fields>, java.io.Serializable, Cloneable, Comparable<OneOfEachBeans> {
  ...
  static {
    schemes.put(StandardScheme.class, new OneOfEachBeansStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OneOfEachBeansTupleSchemeFactory());
  }
...
;
  ...
  public void set_base64(byte[] base64) {
    set_base64(base64 == null ? (ByteBuffer)null : ByteBuffer.wrap(base64));
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case BOOLEAN_FIELD:
      return Boolean.valueOf(is_boolean_field());

    case A_BITE:
      return Byte.valueOf(get_a_bite());

    case INTEGER16:
      return Short.valueOf(get_integer16());

    case INTEGER32:
      return Integer.valueOf(get_integer32());

    case INTEGER64:
      return Long.valueOf(get_integer64());

    case DOUBLE_PRECISION:
      return Double.valueOf(get_double_precision());
